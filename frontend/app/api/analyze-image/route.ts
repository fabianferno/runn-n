      ...
      messages: [
        {
          role: "system",
          content:
            "You are an image analysis assistant. You must respond with ONLY a single word: 'yes' or 'no'. Do not provide any explanation, confidence scores, or additional text. Just answer 'yes' if the image meets the condition, or 'no' if it doesn't.",
        },
        {
          role: "user",
          content: [
